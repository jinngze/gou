...
import com.example.dell.jingze20181221.view.ConView;
...
public class ProductsAdapter extends RecyclerView.Adapter<ProductsAdapter.MViewHolder> {
    ...
    @NonNull
    @Override
    public ProductsAdapter.MViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(@NonNull ProductsAdapter.MViewHolder mViewHolder, final int i) {
